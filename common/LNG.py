...
allLng = {
    'zh_cn': {
        ...
        'sign_in': '请登录',
        'login_expired': '登录失效',
        'openlist_not_found': '未找到OpenList，可能已经被删除',
        'del_job_course_error': '作业启动过程中报错，将自动删除作业，任务为 {}',
        'job_not_found': '未找到作业，可能已经被删除',
        'task_not_found': '未找到任务，可能已经被删除',
        'user_not_found': '用户不存在',
        'openlist_connect_fail': 'OpenList连接失败，请检查是否填写正确',
        'address_incorrect': 'OpenList地址格式有误',
        'code_not_200': '状态码非200',
        'openlist_un_auth': 'OpenList鉴权失败，可能是令牌已失效',
        'openlist_fail_code_reason': 'OpenList返回{}错误，原因为：{}',
        'without_token': '地址改变时令牌必填',
        'add_openlist_client_fail': '新增OpenList客户端时失败，原因为：{}',
    ...
    'eng': {
        ...
        'openlist_not_found': 'OpenList not found, may have been deleted',
