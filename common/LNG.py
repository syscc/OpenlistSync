...
allLng = {
    'zh_cn': {
        ...
        'sign_in': '请登录',
        'login_expired': '登录失效',
        'alist_not_found': '未找到OpenList，可能已经被删除',
        'del_job_course_error': '作业启动过程中报错，将自动删除作业，任务为 {}',
        'job_not_found': '未找到作业，可能已经被删除',
        'task_not_found': '未找到任务，可能已经被删除',
        'user_not_found': '用户不存在',
        'alist_connect_fail': 'OpenList连接失败，请检查是否填写正确',
        'address_incorrect': 'OpenList地址格式有误',
        'code_not_200': '状态码非200',
        'alist_un_auth': 'OpenList鉴权失败，可能是令牌已失效',
        'alist_fail_code_reason': 'OpenList返回{}错误，原因为：{}',
        'without_token': '地址改变时令牌必填',
        'add_alist_client_fail': '新增OpenList客户端时失败，原因为：{}',
        'task_may_delete': '任务未找到。可能是您手动到OpenList中删除了复制任务；或者OpenList因手动/异常奔溃被重启，导致任务记录丢失',
        ...
        'task_end_msg_title': '{} - OpenListSync',
        ...
        'notify_test_msg': '这是一条由您自己发送的OpenListSync测试消息，当你看到这条消息，说明你的配置是正确可用的。'
    },
    'eng': {
        'success': 'success',
        ...
        'alist_not_found': 'OpenList not found, may have been deleted',
        ...
        'alist_connect_fail': 'OpenList connection failed, please check whether it is filled in correctly',
        'address_incorrect': 'The OpenList address format is incorrect',
        'code_not_200': 'Code not 200',
        'alist_un_auth': 'OpenList authentication failed, possibly because the token has expired',
        'alist_fail_code_reason': 'OpenList returns {}, reason: {}',
        'without_token': 'Token is required when address changes',
        'add_alist_client_fail': 'Failed to add OpenList client, reason: {}',
        'task_may_delete': 'task not found. You may have manually deleted the replication task in OpenList; or OpenList was restarted manually or abnormally, resulting in the loss of task records',
        ...
        'notify_test_msg': 'This is an OpenListSync test message sent by yourself. '
